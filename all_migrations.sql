-- ============================================================
-- HomeBook · 全部迁移合并（自动生成，供 Studio SQL Editor 一次执行）
-- 生成时间: 2026-07-12 14:36:19
-- 顺序 = 文件名字典序（= 时间戳顺序），共 31 个文件
-- 用法: 整段粘进 Supabase Studio → SQL Editor → Run。
--       多语句会在一个隐式事务里执行，全成或全滚（适合空库从零建，不会留半成品）。
--       若某段报错，看报错上方最近的 '===== 文件名 ====='，从那一段起单独往后跑。
-- 注意: 本文件只为方便执行，勿放进 supabase/migrations/（会被当成新迁移重复跑）。
-- ============================================================


-- ============================================================
-- ===== 20260617120001_extensions.sql =====
-- ============================================================
-- 0001 · 扩展与基础 schema
-- ----------------------------------------------------------------------------
-- 说明：
...
-- ============================================================
-- ===== 20260617120002_core_tables.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260617120003_ledger_savings_tables.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260617120004_budget_tables.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260617120006_constraints_triggers.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260617120007_rls_helpers.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260617120008_rls_policies.sql =====
-- ============================================================
-- 0008 · 行级安全（RLS）策略
-- ----------------------------------------------------------------------------
...
-- ============================================================
-- ===== 20260617120009_rpc_functions.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260617120010_seed_system_categories.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260618120011_create_invitation_rpc.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260619120012_family_lifecycle_rpcs.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260619120013_remove_member_rpc.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260619120014_delete_savings_goal_rpc.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260621120015_join_reactivate_membership.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260622120016_family_hidden_categories.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260622120017_preview_family_by_code_rpc.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260622120018_invitation_code_6char.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260622120019_fix_dissolved_family_member_count.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260622120020_storage_policies.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260624120021_storage_policies_flat_paths.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260624120022_storage_policies_owner_based.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260627120023_transaction_last_editor.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260703120024_delete_account_rpc.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260704120026_notification_preferences.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260704120027_device_tokens.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260705120028_accounting_preferences.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260705120029_recurring_transactions.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260705120030_accounting_prefs_summary_entry.sql =====
-- ============================================================
...
-- ============================================================
-- ===== 20260707120028_notification_pushed_at.sql =====
-- ============================================================
