...
> 文档版本：v0.2.4（首页概览重构：本月概览卡 + 独立超支条幅 → 合并为 hero「本月脉搏卡」（预算口径 · 锁本月 · 超支预警内联 warning/danger 态）；月度总结升级为首页 hero 整卡点击进入的全屏、可翻月视图（默认本月至今），报表 Tab 内不再设月度总结入口。对应 PRD 流程 8/9、§10.4/§10.6/§11。历史：v0.2.3 家庭页加入入口细化）
> 最后更新：2026-06-27
