...
-- ============================================================
-- >>> migrations/20260723120032_family_member_limit_5.sql
-- ============================================================
-- 0032 · 家庭成员上限调整为 5 人
--
...
-- ============================================================
-- >>> migrations/20260724120033_family_background_bucket.sql
-- ============================================================
-- 0033 · 家庭背景图独立桶
--
...
-- ============================================================
-- >>> migrations/20260724120034_family_slogan.sql
-- ============================================================
-- 0034 · 家庭口号 + 邀请预览家庭头像
-- -----------------------------------------------------------------------------
...
-- ============================================================
-- >>> migrations/20260726120035_verification_delivery_daily_limit.sql
-- ============================================================
-- 0035 · 验证码每日发送上限
-- -----------------------------------------------------------------------------
...
-- ============================================================
-- >>> migrations/20260726120036_password_login_lockout.sql
-- ============================================================
-- 0036 · 邮箱密码登录失败锁定
-- -----------------------------------------------------------------------------
...
-- ============================================================
-- >>> migrations/20260803120037_home_dashboard_rpc.sql
-- ============================================================
...
-- ============================================================
-- >>> migrations/20260826120040_notification_delete_after_read.sql
-- ============================================================
...
-- ============================================================
-- >>> migrations/20260826120041_notification_producers.sql
-- ============================================================
...
-- ============================================================
-- >>> migrations/20260826120042_notification_push_retry.sql
-- ============================================================
-- 0042 · 系统推送投递重试状态。
